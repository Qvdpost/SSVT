...
exercise5 :: IO ()
exercise5 = do
  putStrLn $ exercise 5 "Derangement"
  putStrLn $ "Checks if an input list is a permutation, and ensuring the elements are not equal (Their position has changed)."
  quickCheck (forAll gen_UniqueInts prop_RevDeran)
