...
suite('numbers', function () {
  ...
  test('should be able to check equality of two floating point numbers', function (done) {
    ...
    // TODO: Remove this test. Why is it here??
  ...
  test('numbersEqual should throw an exception when given a non number', function (done) {
    assert.throws(
      function () {
        basic.numbersEqual(5, '5', numbers.EPSILON);
      },
  ...
  test('numbersEqual should check for error both above and below zero correctly', function (done) {
    assert.equal(basic.numbersEqual(5, 3, 1), false);
    assert.equal(basic.numbersEqual(3, 5, 1), false);
    done();
  });

  test('numbersEqual accuracy should be WITHIN the limits of epsilon', function (done) {
    assert.equal(basic.numbersEqual(3, 2, 1), false);
    assert.equal(basic.numbersEqual(2, 3, 1), false);
    done();
  });
